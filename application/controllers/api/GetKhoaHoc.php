		...
		if(empty($id)){
			$data = $this->M_DATA->load_data('*',
										...
										'khoahoc.MaGV=giangvien.MaGV and giangvien.MaKH=khachhang.MaKH and capbac.MaCB=khoahoc.MaCB and chude.MaCD = khoahoc.MaCD 
											and khoahoc.MaKhoaHoc = khuyenmaikhoahoc.MaKhoaHoc',
										);
			...
			$data = $this->M_DATA->load_data('*',
										'khoahoc,giangvien,khachhang,chude,capbac,khuyenmaikhoahoc',
										'khoahoc.MaGV=giangvien.MaGV and giangvien.MaKH=khachhang.MaKH and khoahoc.MaKhoaHoc = khuyenmaikhoahoc.MaKhoaHoc and capbac.MaCB=khoahoc.MaCB and chude.MaCD = khoahoc.MaCD and khoahoc.MaKhoaHoc = '.$id.'',
										);
			$this->response($data,200);
		}
	}
